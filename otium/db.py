...
# 
# 
# This should be renamed to 'writeCycleDates' and the finding should be done in route
# also this should not return anything
# Also, this makes sense, since the Heroku deployment was choking on the same thing
def findCycleDates(decline=.1):
    ...
    # engine = create_engine('sqlite:///./../instance/otium.db', echo = False)
    cycleData.to_sql('cycle_dates', con=db.engine, if_exists='replace')
